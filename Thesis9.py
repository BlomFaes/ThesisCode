# rocket_evolution_thesis_perfect.py
# YOUR ORIGINAL CODE + PERFECT BRAIN VISUALIZATION — NO CHANGES TO LOGIC
...
def draw_neural_network(screen, brain, inputs, outputs):
    ...
    for i, (px, py) in enumerate(input_pos):
        txt = font.render(["dx","h","vx","vy","ang","dist"][i], True, (255,255,255))
